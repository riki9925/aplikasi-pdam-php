...
function datatgl() {
  ...
  $('#data').load('modal/pemasukan.php?date='+date1);
}
        ...
        <div class="block full">
            ...
            <form id="form-validation" action="#" class="form-horizontal form-bordered">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="keterangan" name="keterangan" rows="5" class="form-control" placeholder="Keterangan pemasukkan"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" id="total" name="total" class="form-control" placeholder="Total pemasukkan">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" id="id_pemasukan" name="id_pemasukan">
    ...
    $.ajax({
        ...
        success : function(pesan){
            if(pesan=='ok'){
                ...
                swal('SUKSES!', 'Tambah data pemasukan berhasil', 'success');
                setTimeout(function(){ datatgl(); }, 1000);
            }
            else{
                swal('PERINGATAN!', 'Tambah data pemasukan gagal', 'warning');
            }
        },
    });
}
...
function ubah(){
    ...
    $.ajax({
        ...
        success : function(pesan){
            if(pesan=='ok'){
                $('#form-validation')[0].reset();
                swal('SUKSES!', 'Edit data pemasukan berhasil', 'success');
                setTimeout(function(){ datatgl(); }, 1000);
                actioncancel();
            }
            else{
                swal('PERINGATAN!', 'Edit data pemasukan gagal', 'warning');
            }
        },
    });
}
        ...
        $.ajax({
            ...
            success : function(pesan){
                if(pesan=='ok'){
                    ...
                    swal('PERINGATAN!', 'Hapus data pemasukan gagal', 'warning');
                }
            },
        });
    });
...
function lihat(id){
    $('#submit').hide();
    $('#update').show();
    $('#judul').text('EDIT DATA PEMASUKKAN');
    ...
    $.ajax({
        ...
        success : function(pesan){
            if(pesan != null){
                $('#form-validation')[0].reset();
                $('#id_pemasukan').val(pesan.id_pemasukan);
                ...
                swal('PERINGATAN!', 'Lihat data pemasukkan gagal', 'warning');
            }
        },
    });
}
